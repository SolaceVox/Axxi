        ...
        <nav className="w-full max-w-4xl">
          <div className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur-sm p-8 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a
                className="group flex items-start gap-4 rounded-xl border border-gray-100 bg-white p-6 transition-all hover:border-blue-200 hover:bg-blue-50 hover:shadow-md"
                href="https://remix.run/start/quickstart"
                target="_blank"
                rel="noreferrer"
              >
                <div className="flex-shrink-0 rounded-lg bg-blue-100 p-2 group-hover:bg-blue-200">
                  <svg
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Get up and running with Remix in 5 minutes
                  </p>
                </div>
                <svg
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Learn Remix fundamentals with a hands-on tutorial
                  </p>
                </div>
                <svg
                  className="h-5 w-5 text-gray-400 transition-transform group-hover:translate-x-1 group-hover:text-blue-600"
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Connect with other Remix developers
                  </p>
                </div>
                <svg
                  className="h-5 w-5 text-gray-400 transition-transform group-hover:translate-x-1 group-hover:text-blue-600"
